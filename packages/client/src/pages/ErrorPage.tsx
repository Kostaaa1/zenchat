...
const ErrorPage = () => {
  ...
  return (
    <MainContainer>
      ...
      >
        <h3 className="text-2xl font-semibold">Sorry, this page isn't available.</h3>
        <p>The link you followed may be broken, or the page may have been removed. Go back to main page.</p>
      </div>
    </MainContainer>
  )
}
