...
const Button: FC<ButtonProps> = ({ children, variant, buttonColor, size, className, isLoading, ...props }) => {
  return (
    <button className={cn(buttonVariants({ variant, buttonColor, size, className }))} disabled={isLoading} {...props}>
